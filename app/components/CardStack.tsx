                ...
                <div className="card-container " style={{ position: 'relative', width: "100%", height: "100%" }}>
                    ...
                    >
                        <div className="text-left">
                            {(index === 0 || index === 3) && (
                                <div className="pl-0 md:pl-7 lg:pl-14 lg:py-14 py-0 lg:pt-0 pt-1 w-full font-[rubik]">
                            ...
                            {(index === 1 || index === 4) && (
                                <div className="pl-0 md:pl-7 lg:pl-14 lg:pt-0 pt-1 font-[rubik] w-full md:w-8/12 slide-left">
                            ...
                            {(index === 2 || index === 5) && (
                                <div className="flex">
                                    <div className="relative w-4/12 pl-0 md:w-5/12 md:pl-5 flex items-start justify-start ">
                                        {/* Responsive Image */}
