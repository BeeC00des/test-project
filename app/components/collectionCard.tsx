...
function CollectionCard({numberTitle, headerText, unit, backgroundImage, index, id,  marginTop, specialUppertext,afterBtnText, beforeBtnText,smallCardsData, top, customerName, img, uppertext,
