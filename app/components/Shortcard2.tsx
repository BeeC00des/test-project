    ...
    return (
        <div className="lg:flex justify-center items-center  my-12 md:my-0 ">
            <div className="lg:w-11/12 md:w-auto sm:w-full lg:h-[400px] md:h-auto sm:h-auto sm:my-50 mx-5 lg:ml-16 lg:my-20   block md:flex justify-between items-center">
                <div className="hidden md:block justify-center items-center lg:w-5/12">
                ...
                <div className="px-0 md:px-2">
                        ...
                        <div className="flex relative">
                            ...
                            <Image src={img} alt="coin" width={100} height={100} className="hidden md:block absolute lg:top-[70px]  lg:left-[400px] md:top-[50px] md:left-[170px]" />
                        </div>
                    </div>
                </div>
            </div>
