...
function DisbursementCard({numberTitle, headerText, unit, backgroundImage, index, id,  marginTop, specialUppertext,afterBtnText, beforeBtnText,smallCardsData, top, customerName, img, uppertext,
                                                ...
                                                >
                                                    <div className="small-card-container">
                                                        {smallCardsData.map((smallCard) => (
                                                            <div
                                                                key={smallCard.id}
                                                                className="flex justify-center items-center text-left backdrop-blur-lg text-white bg-white/7 p-10 border"
                                                                style={{
                                                                    height: "300px",
                                                                    margin: "30px",
                                                                    borderRadius: "40px",
